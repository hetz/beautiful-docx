...
exports.textToPngBuffer = exports.getUUID = exports.hasSpacesAtEnd = exports.hasSpacesAtStart = exports.parseSizeValue = exports.parsePaddingsMergedValue = exports.parsePaddings = exports.getPageWidth = exports.isListTag = exports.getIndent = exports.cleanTextContent = exports.supportHtmlTextContent = exports.parseTextAlignment = exports.convertPointsToTwip = exports.convertTwipToPixels = exports.convertPixelsToTwip = exports.convertPointsToPixels = exports.convertPixelsToPoints = exports.parseStyles = exports.getAttributeMap = exports.PIXELS_TO_POINT_RATIO = exports.FIRST_LINE_INDENT_MILLIMETERS = void 0;
...
const supportHtmlTextContent = (content) => {
    return content
        .replace(/&lt;/g, '<')
        .replace(/&gt;/g, '>')
        .replace(/&amp;/g, '&')
...
exports.supportHtmlTextContent = supportHtmlTextContent;
...
const hasSpacesAtStart = (str) => {
    return str.trimStart() !== str;
};
exports.hasSpacesAtStart = hasSpacesAtStart;
const hasSpacesAtEnd = (str) => {
    return str.trimEnd() !== str;
};
exports.hasSpacesAtEnd = hasSpacesAtEnd;
const getUUID = () => {
    return (Math.random().toString(16).substring(2) +
        Math.random().toString(16).substring(2) +
        new Date().getTime().toString(16)).substr(0, 32);
};
exports.getUUID = getUUID;
const textToPngBuffer = (text, width = 600, height = 50) => {
...
exports.textToPngBuffer = textToPngBuffer;
