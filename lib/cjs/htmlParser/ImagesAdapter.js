...
class ImagesAdapter {
    ...
    downloadImages(root) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(this.imagesUrls.entries()), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const [index, url] = _c;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (url) {
                    ...
                    if ((0, fs_1.existsSync)(file_url_path)) {
                        console.log(`Cache url hit: ${url}`);
                        return (0, fs_1.readFileSync)(file_url_path);
                    }
                    else if ((0, fs_1.existsSync)(file_hash_path)) {
                        console.log(`Cache hash hit: ${url}`);
                        return (0, fs_1.readFileSync)(file_hash_path);
                    }
                    else {
                        const res = yield this.axiosIns.get(url, { responseType: 'arraybuffer', timeout: 5000 });
                        yield (0, image_size_1.default)(res.data);
                        (0, fs_1.writeFileSync)(file_hash_path, res.data);
